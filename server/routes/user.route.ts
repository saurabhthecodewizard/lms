...
import { activateUser, externalAuth, fetchAllUsers, getUserInfo, login, logout, register, updateAccessToken, updateAvatar, updatePassword, updateUserInfo } from '../controllers/user.controller';
