...
import { activateUser, externalAuth, fetchAllUsers, getUserInfo, login, logout, register, updateAccessToken, updateAvatar, updatePassword, updateUserInfo, updateUserRole } from '../controllers/user.controller';
